...
# =============================================================================
#  Script de Instalação Automática: Apache2 + PHP 8.5
#  Uso: curl -sSL <url_do_script> | sudo bash
#
#  Esta versão usa o PHP que já vem nos repositórios OFICIAIS do sistema
#  (ex.: Ubuntu 'resolute', que traz PHP 8.5 nativo). NÃO precisa da PPA
#  do Ondrej — por isso não há aquele problema de "404 / Release não
#  encontrado" em releases novas.
# =============================================================================

set -e

# ---- Versão do PHP (a versão nativa do sistema) ----
PHP_VERSION="8.5"
...
echo "   (repositórios oficiais do sistema, sem PPA)"
echo "============================================================"
echo ""
...
# =============================================================================
# PASSO 3 — Instalar PHP base + módulo do Apache
#  (sem PPA — direto dos repos oficiais)
# =============================================================================
...
# =============================================================================
# PASSO 4 — Instalar zip, unzip e utilitários base
# =============================================================================
...
# =============================================================================
# PASSO 6 — Garantir que o Apache use o módulo do PHP correto
# =============================================================================
...
# =============================================================================
# PASSO 7 — Configurar php.ini (max_execution_time = 0)
# =============================================================================
...
# =============================================================================
# PASSO 8 — Configurar permissões /var/www
# =============================================================================
